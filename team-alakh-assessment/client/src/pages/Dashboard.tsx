...
//               style={{
//                 boxShadow:
//                   "0 4px 32px 0 rgba(255,255,255,0.08), 0 1.5px 8px 0 rgba(80,80,80,0.10)",
//               }}
//             >
//               {loading ? (
...
//                           prereq
//                         )} rounded-2xl p-6 shadow-lg border border-amber-200 dark:border-amber-700 hover:shadow-xl transition-shadow duration-200 cursor-pointer`}
...
//                           </div>
//                           <div>
//                             <h4 className="font-semibold text-gray-900 dark:text-amber-900">
//                               {prereq}
//                             </h4>
...
//                     <span className="flex items-center gap-1 text-xs font-medium">
//                       <span className="inline-block w-4 h-4 rounded-full bg-green-200 border border-green-400 mr-1"></span>{" "}
//                       <span className="text-green-700">Passed</span>
//                     </span>
//                     <span className="flex items-center gap-1 text-xs font-medium">
//                       <span className="inline-block w-4 h-4 rounded-full bg-amber-200 border border-amber-400 mr-1"></span>{" "}
...
//                       key={prereq}
//                       onClick={() => handlePrereqClick(prereq)}
//                       className={`flex items-center gap-2 px-5 py-2 rounded-full text-sm font-semibold border shadow-sm cursor-pointer transition-all duration-200 hover:scale-105 focus:outline-none ${getPrereqColor(
//                         prereq
//                       )}`}
//                     >
//                       {passedTopics.includes(prereq) ? (
...
//                     className={`${getPrereqColor(
//                       ""
//                     )} text-gray-700 dark:text-amber-600 px-3 py-1 rounded-full text-xs hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors`}
//                   >
//                     Complete Profile
//                   </button>
//                 )}
...
//               <HelpCircle className="w-6 h-6" /> Your Queries
//             </div>
//             <button
...
//               <div
//                 key={q._id}
//                 className="bg-white/80 dark:bg-gray-800/80 rounded-xl p-4 border border-gray-200/40 dark:border-gray-700/60 flex flex-col md:flex-row md:items-center md:justify-between gap-2"
//               >
//                 <div className="flex-1">
...
//                             className="inline-block w-12 h-12 rounded-lg overflow-hidden border border-gray-300 dark:border-gray-700"
//                           >
//                             <img
//                               src={a.url}
//                               alt="attachment"
...
//                     }
//                     className="text-red-500 hover:text-red-700 p-2 rounded-full bg-red-100/60 hover:bg-red-200 transition"
//                     title="Delete Query"
...
//               className="w-full mt-4 bg-gradient-to-r from-blue-500 to-indigo-500 text-white px-6 py-3 rounded-xl font-bold shadow-lg hover:scale-105 transition flex items-center justify-center gap-2"
//             >
//               <HelpCircle className="w-5 h-5" /> Raise New Query
//             </button>
//           </div>
//           {queryPanelOpen && queryToastMsg && (
//             <div
//               className={`fixed top-4 right-8 z-[10000] px-6 py-3 rounded-xl shadow-lg font-bold text-white ${
...
//               <button
//                 type="submit"
//                 className="bg-gradient-to-r from-blue-500 to-indigo-500 text-white px-6 py-2 rounded-xl font-semibold shadow hover:scale-105 transition"
//                 disabled={queryLoading}
//               >
//                 {queryLoading ? "Sending..." : "Send Query"}
//               </button>
//               {queryMsg && (
//                 <div className="text-blue-600 font-medium mt-2">{queryMsg}</div>
//               )}
//             </form>
//           </div>
//         </Modal>
      ...
      <div className="bg-white/80 dark:bg-[#181818]/70 backdrop-blur-md shadow-sm border-b border-gray-200 dark:border-gray-800 sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-4 py-3 sm:py-4 flex items-center justify-between">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            {userEmail && (
              <div className="hidden sm:flex relative flex items-center space-x-2 bg-gray-50 dark:bg-gray-800 px-2 sm:px-3 py-2 rounded-lg hover-glow group">
                <button
                  onClick={() => setShowProfile(true)}
                  className="hidden sm:block text-gray-700 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 transition-colors"
                  aria-label="Open Profile"
                >
      ...
      <div className="max-w-6xl mx-auto px-4 py-6 sm:py-8">
        ...
        {(canProceed ||
          ...
          <div className="mb-6 sm:mb-8">
              ...
              <div className="bg-gradient-to-r from-amber-50 to-orange-50 dark:from-amber-950 dark:to-orange-950 border border-amber-200 dark:border-amber-800 rounded-xl sm:rounded-3xl overflow-hidden">
                <div className="p-6 sm:p-8">
                  <div className="flex items-center mb-4 sm:mb-6">
                    ...
                    <h3 className="text-xl sm:text-2xl font-semibold text-amber-900 dark:text-amber-200">
                      Prerequisites Required
                    </h3>
                  </div>
                  <p className="text-amber-800 dark:text-amber-300 mb-6 sm:mb-8 text-base sm:text-lg">
                    To master{" "}
                    <strong className="text-amber-900 dark:text-amber-100">
                      {topic}
                    </strong>
            ...
            {allPrereqs.length > 0 && (
              <div className="mb-6 bg-white/80 dark:bg-gray-900/80 border border-gray-200 dark:border-gray-700 rounded-lg sm:rounded-2xl p-4 sm:p-6 shadow flex flex-col gap-3 sm:gap-4">
                ...
                <div className="flex flex-wrap gap-2 sm:gap-3 mt-1 sm:mt-2">
                  {allPrereqs.map((prereq) => (
                    <button
                      key={prereq}
                      onClick={() => handlePrereqClick(prereq)}
                      className={`flex items-center gap-1 sm:gap-2 px-3 sm:px-5 py-1 sm:py-2 rounded-full text-xs sm:text-sm font-semibold border shadow-sm cursor-pointer transition-all duration-200 hover:scale-105 focus:outline-none ${getPrereqColor(
                        prereq
                      )}`}
                    >
                      {passedTopics.includes(prereq) ? (
