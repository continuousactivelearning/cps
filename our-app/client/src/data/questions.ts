  ...
  // Hard C++ Questions
{
  ...
  correctAnswer: 1,
  explanation: "The `show()` function in `Base` is virtual and overridden in `Derived`. Since `b` is a pointer to `Base` but points to a `Derived` object, dynamic dispatch calls `Derived::show()`, so it prints `Derived`.",
  language: "C++",
  difficulty: "hard"
},
{
...
{
  id: 24,
  question: "Which of the following features is **not** natively supported by C++?",
  options: ["Multiple Inheritance", "Garbage Collection", "Templates", "Operator Overloading"],
  correctAnswer: 1,
  explanation: "C++ does not provide built-in garbage collection like some other languages (e.g., Java). Developers are responsible for manual memory management using `new` and `delete`. The other features — multiple inheritance, templates, and operator overloading — are fully supported in C++.",
  language: "C++",
  difficulty: "hard"
},
{
...
{
  id: 51,
  question: "Which of the following is **not** a standard Java access modifier?",
  options: ["public", "protected", "sealed", "private"],
  correctAnswer: 2,
  explanation: "`sealed` is not a standard access modifier in Java. It was introduced in Java 15 as a contextual keyword to define sealed classes, but it does not control access like `public`, `private`, or `protected`.",
  language: "Java",
  difficulty: "hard"
},
{
...
{
  id: 53,
  question: "Which of the following Java collections is synchronized by default?",
  options: ["ArrayList", "HashMap", "Vector", "LinkedList"],
  correctAnswer: 2,
  explanation: "`Vector` is synchronized by default in Java. Other collections like `ArrayList`, `HashMap`, and `LinkedList` are not thread-safe unless externally synchronized.",
  language: "Java",
  difficulty: "hard"
},
{
  ...
  // Hard JavaScript Questions
{
  ...
  options: ["Symbol", "Set", "String", "Undefined"],
  correctAnswer: 1,
  explanation: "`Set` is not a primitive data type in JavaScript; it is a built-in object used to store unique values. `Symbol`, `String`, and `Undefined` are all primitive data types.",
  language: "JavaScript",
  difficulty: "hard"
},
{
...
{
  id: 85,
  question: "Which of the following is most likely to cause an infinite loop if not handled properly?",
  options: ["while(true)", "for(;;)", "do...while(false)", "setTimeout()"],
  correctAnswer: 0,
  explanation: "`while(true)` creates a loop that runs endlessly unless a `break` or return condition is introduced inside the loop body. `for(;;)` can also cause an infinite loop but is less common. `do...while(false)` executes only once, and `setTimeout()` is a one-time delayed execution.",
  language: "JavaScript",
  difficulty: "hard"
},
  {
  ...
  // Hard Python Questions
{
  ...
  correctAnswer: 1,
  explanation: "`Tuple` is an immutable data structure in Python, meaning its contents cannot be changed after creation. `List`, `Dictionary`, and `Set` are mutable and allow modifications.",
  language: "Python",
  difficulty: "hard"
},
{
...
},
{
  ...
  options: [
    ...
    "Consume less memory",
    "Are functions with `return`",
    "Support lazy evaluation"
  ],
  correctAnswer: 2,
  explanation: "Generators use `yield`, not `return`, to produce values one at a time. This enables lazy evaluation and memory efficiency. Using `return` in a generator ends iteration and optionally provides a final value, but it does not make it a generator.",
  language: "Python",
  difficulty: "hard"
},
{
